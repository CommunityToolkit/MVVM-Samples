...
{
    public abstract class MessengerSamplePageViewModel : SamplePageViewModel
    {
        public MessengerSamplePageViewModel(IFilesService filesService) : base(filesService)
        {
        ...
        public void Loaded()
        {
            SenderViewModel.IsActive = true;
            ReceiverViewModel.IsActive = true;
        }

        public void Unloaded()
        {
            SenderViewModel.IsActive = false;
            ReceiverViewModel.IsActive = false;
        }
